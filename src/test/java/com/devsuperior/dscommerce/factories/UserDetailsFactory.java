...
public class UserDetailsFactory {
    public static List<UserDetailsProjection> createRoleClientUserDetails(String username) {
    ...
    public static List<UserDetailsProjection> createRoleAdminUserDetails(String username) {
